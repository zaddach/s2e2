...
SET ( QEMU_GENERATED_FILES )
LIST ( APPEND QEMU_GENERATED_FILES "${QEMU_BUILD}/config-host.h")
...
FOREACH ( QEMU_TARGET_DIR ${QEMU_TARGET_DIRS} )
    ...
    LIST ( APPEND QEMU_GENERATED_FILES "${QEMU_BUILD}/${QEMU_TARGET_DIR}/qemu-system-${QEMU_ARCH}" )
	LIST ( APPEND QEMU_GENERATED_FILES "${QEMU_BUILD}/${QEMU_TARGET_DIR}/config-target.h" )
...
ADD_CUSTOM_COMMAND ( OUTPUT ${QEMU_GENERATED_FILES}
     COMMAND make -j8
     WORKING_DIRECTORY ${QEMU_BUILD}
     COMMENT "Build Qemu"
     VERBATIM)
